  ...
  return (
    ...
    >
        ...
        <div className="relative flex aspect-square w-full items-center justify-center overflow-hidden rounded-[16px] bg-white group-hover:overflow-visible md:rounded-[18px]">
          ...
          <div className="absolute right-1.5 bottom-1.5 z-20 opacity-100 transition-all duration-400 md:translate-y-3 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100">
            <button
              ...
              className="flex h-7 w-7 items-center justify-center rounded-full border border-[rgba(122,37,51,0.15)] bg-white text-[#7A2533] shadow-sm md:h-auto md:w-auto md:rounded-full md:px-3.5 md:py-2 md:text-[10px] md:font-semibold md:tracking-[0.14em] md:uppercase"
            >
      ...
      <div className="flex flex-1 flex-col px-2 pt-2 pb-2.5 md:px-3 md:pt-3 md:pb-3.5">
        ...
        {pl ? (
          <p className="font-display mt-1 line-clamp-2 min-h-[2.35em] text-[12px] leading-snug font-semibold text-[#1a1a2e] transition-colors group-hover:text-[#7A2533] md:mt-1.5 md:min-h-[36px] md:text-[14px]">
            {product.name}
          </p>
        ) : (
