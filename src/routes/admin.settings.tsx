    ...
    <AdminLayout>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D]"
              />
            </div>
          </div>
        </div>
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`rounded-lg border px-3 py-2.5 text-xs font-semibold min-h-[44px] ${previewMode === "desktop" ? "border-[#9C544D] bg-[#fdf8f3] text-[#1a1a2e]" : "border-gray-200 text-gray-500"}`}
                >
                  Desktop
                </button>
                <button
                  ...
                  className={`rounded-lg border px-3 py-2.5 text-xs font-semibold min-h-[44px] ${previewMode === "mobile" ? "border-[#9C544D] bg-[#fdf8f3] text-[#1a1a2e]" : "border-gray-200 text-gray-500"}`}
                >
                  Mobile
                </button>
              </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={!!emailBusy}
                className="inline-flex flex-1 items-center justify-center gap-2 rounded-lg border border-[#9C544D] px-4 py-2.5 text-sm font-semibold text-[#8a681f] hover:bg-[#fdf8f3] disabled:opacity-50 min-h-[44px]"
              >
                {emailBusy === "preview" ? (
            ...
            <div className="rounded-xl border border-gray-200 bg-white">
              <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3">
                <h4 className="flex items-center gap-2 text-sm font-bold text-[#1a1a2e]">
                  <Mail className="h-4 w-4 text-[#9C544D]" /> Test Email History
                </h4>
                <button
                  type="button"
        ...
        <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <input type="checkbox" id="gp-enabled" checked={giftCfg.enabled} onChange={(e) => setGiftCfg({ ...giftCfg, enabled: e.target.checked })} className="h-4 w-4 rounded border-gray-300 text-[#9C544D] focus:ring-[#9C544D]" />
            ...
            <div>
              ...
              <input value={giftCfg.name} onChange={(e) => setGiftCfg({ ...giftCfg, name: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Description</label>
              <textarea value={giftCfg.description} onChange={(e) => setGiftCfg({ ...giftCfg, description: e.target.value })} rows={2} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D]" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Price (₹)</label>
              <input type="number" value={giftCfg.price} onChange={(e) => setGiftCfg({ ...giftCfg, price: Number(e.target.value) })} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]" />
            </div>
            <div className="flex items-center gap-3">
              <input type="checkbox" id="gp-msg" checked={giftCfg.allow_gift_message} onChange={(e) => setGiftCfg({ ...giftCfg, allow_gift_message: e.target.checked })} className="h-4 w-4 rounded border-gray-300 text-[#9C544D] focus:ring-[#9C544D]" />
            ...
            {giftCfg.allow_gift_message && (
              <div>
                ...
                <input type="number" value={giftCfg.max_message_length} onChange={(e) => setGiftCfg({ ...giftCfg, max_message_length: Number(e.target.value) })} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]" />
              </div>
            )}
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Status</label>
              <select value={giftCfg.status} onChange={(e) => setGiftCfg({ ...giftCfg, status: e.target.value as "active" | "inactive" })} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]">
        ...
        <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <input type="checkbox" id="est-enabled" checked={estCfg.enabled} onChange={(e) => setEstCfg({ ...estCfg, enabled: e.target.checked })} className="h-4 w-4 rounded border-gray-300 text-[#9C544D] focus:ring-[#9C544D]" />
            ...
            <div>
              ...
              <input type="number" value={estCfg.min_days} onChange={(e) => setEstCfg({ ...estCfg, min_days: Number(e.target.value) })} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Max Days</label>
              <input type="number" value={estCfg.max_days} onChange={(e) => setEstCfg({ ...estCfg, max_days: Number(e.target.value) })} className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none focus:border-[#9C544D] min-h-[44px]" />
            </div>
          </div>
        </div>
      </div>
