        ...
        <div className="mb-6 rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <select value={form.coupon_scope} onChange={(e) => setForm({ ...form, coupon_scope: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#c9a96e]">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <input type="datetime-local" value={form.start_date} onChange={(e) => setForm({ ...form, start_date: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#c9a96e]" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Customer Group</label>
              <input value={form.customer_group} onChange={(e) => setForm({ ...form, customer_group: e.target.value })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#c9a96e]" placeholder="VIP, Wholesale, etc." />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Min Items</label>
              <input type="number" value={form.min_items} onChange={(e) => setForm({ ...form, min_items: Number(e.target.value) })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#c9a96e]" />
            </div>
            <div>
              <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Max Items</label>
              <input type="number" value={form.max_items} onChange={(e) => setForm({ ...form, max_items: Number(e.target.value) })} className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm outline-none focus:border-[#c9a96e]" />
            </div>
          </div>
              ...
              filtered.map((item) => (
                <button
                  ...
                  className={`flex w-full items-center gap-2 px-3 py-2 text-left text-sm hover:bg-gray-50 ${
                    selected.has(item.id) ? "bg-[#c9a96e]/5 font-medium" : ""
                  }`}
                >
                  <div className={`flex h-4 w-4 items-center justify-center rounded border ${
                    selected.has(item.id) ? "border-[#c9a96e] bg-[#c9a96e]" : "border-gray-300"
                  }`}>
