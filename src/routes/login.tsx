    ...
    <PageShell>
      <div className="mx-auto flex min-h-[70vh] max-w-[440px] items-center justify-center px-4 py-20">
        <div className="w-full rounded-[28px] bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.05)] sm:p-10">
          <p className="text-[11px] font-semibold tracking-[0.24em] text-[#7A2533] uppercase text-center">Welcome</p>
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            <div>
              ...
              <input id="login-email" type="email" value={email} onChange={(e) => { setEmail(e.target.value); setError(""); }} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 text-sm outline-none focus:border-[#7A2533] focus:ring-1 focus:ring-[#7A2533]/30" placeholder="your@email.com" autoComplete="email" />
            </div>
            <div>
              ...
              <div className="relative">
                <input id="login-password" type={showPw ? "text" : "password"} value={password} onChange={(e) => { setPassword(e.target.value); setError(""); }} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 pr-12 text-sm outline-none focus:border-[#7A2533] focus:ring-1 focus:ring-[#7A2533]/30" autoComplete="current-password" />
          ...
          <div className="mt-4 text-center">
            <Link to="/forgot-password" className="text-xs font-medium text-[#7A2533] hover:text-[#7A2533] underline underline-offset-2">Forgot password?</Link>
          </div>
          ...
          <button onClick={handleGoogle} disabled={googleLoading} className="flex w-full items-center justify-center gap-3 rounded-xl border border-[#e0d8cc] bg-white px-4 py-3 text-sm font-medium text-[#1a1a2e] transition-colors hover:border-[#7A2533] hover:bg-[#fdf8f3] disabled:opacity-60">
          ...
          <p className="mt-6 text-center text-sm text-[#7a6e64]">
            ...
            <Link to="/signup" className="font-semibold text-[#7A2533] hover:text-[#7A2533] underline underline-offset-2">Create Account</Link>
          </p>
        </div>
      </div>
    </PageShell>
