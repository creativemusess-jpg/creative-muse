      ...
      <section className="mx-auto max-w-[920px] px-4 py-10 sm:px-6 sm:py-16">
        ...
        >
          <div className="relative">
            <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#C9A96E]" />
            <input
              value={orderNumber}
              onChange={(e) => setOrderNumber(e.target.value)}
              placeholder="Order number"
              required
              className="w-full rounded-[6px] border border-[#e0d8cc] py-3 pl-10 pr-3 text-sm focus:outline-none focus:border-[#c9a96e]"
            />
          </div>
          <input
            value={identity}
            ...
            required
            className="w-full rounded-[6px] border border-[#e0d8cc] px-3 py-3 text-sm focus:outline-none focus:border-[#c9a96e]"
          />
        ...
        {order && (
          <div className="mt-8 rounded-[8px] border border-[#ead8b8] bg-[#fffdf8] p-5 shadow-[0_10px_30px_rgba(40,24,8,0.06)]">
            <div className="flex flex-col gap-4 border-b border-[#ead8b8] pb-5 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-wider text-[#7b5417]">
            ...
            <div className="grid gap-5 py-5 lg:grid-cols-[1fr_320px]">
              ...
              <div className="rounded-[8px] border border-[#ead8b8] bg-white p-4 text-sm">
                <h3 className="mb-3 text-[12px] font-bold uppercase tracking-wider text-[#7b5417]">
                  Shipment
                </h3>
                ...
                {order.tracking_url && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-[6px] bg-[#b7892f] px-4 py-3 text-sm font-semibold text-white"
                  >
