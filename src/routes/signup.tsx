    ...
    <PageShell>
      <div className="mx-auto flex min-h-[70vh] max-w-[440px] items-center justify-center px-4 py-20">
        <div className="w-full rounded-[28px] bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.05)] sm:p-10">
          <p className="text-[11px] font-semibold tracking-[0.24em] text-[#9C544D] uppercase text-center">Join</p>
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-4">
              <div>
                ...
                <input id="signup-name" type="text" value={form.fullName} onChange={update("fullName")} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 text-sm outline-none focus:border-[#9C544D]" autoComplete="name" />
              </div>
              <div>
                <label htmlFor="signup-email" className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-1">Email</label>
                <input id="signup-email" type="email" value={form.email} onChange={update("email")} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 text-sm outline-none focus:border-[#9C544D]" autoComplete="email" />
              </div>
              <div>
                ...
                <input id="signup-phone" type="tel" value={form.phone} onChange={update("phone")} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 text-sm outline-none focus:border-[#9C544D]" autoComplete="tel" />
              </div>
              <div>
                ...
                <div className="relative">
                  <input id="signup-password" type={showPw ? "text" : "password"} value={form.password} onChange={update("password")} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 pr-12 text-sm outline-none focus:border-[#9C544D]" autoComplete="new-password" />
              ...
              <div>
                ...
                <input id="signup-confirm" type="password" value={form.confirmPassword} onChange={update("confirmPassword")} className="w-full rounded-xl border border-[#e0d8cc] px-4 py-3 text-sm outline-none focus:border-[#9C544D]" autoComplete="new-password" />
              </div>
              ...
              <label className="flex items-start gap-2 text-sm text-[#7a6e64]">
                ...
                <span>I accept the <Link to="/terms" className="text-[#9C544D] underline underline-offset-2">Terms</Link> and <Link to="/privacy-policy" className="text-[#9C544D] underline underline-offset-2">Privacy Policy</Link></span>
              </label>
          ...
          <button onClick={handleGoogle} className="flex w-full items-center justify-center gap-3 rounded-xl border border-[#e0d8cc] bg-white px-4 py-3 text-sm font-medium text-[#1a1a2e] transition-colors hover:border-[#9C544D] hover:bg-[#fdf8f3]">
          ...
          <p className="mt-6 text-center text-sm text-[#7a6e64]">
            ...
            <Link to="/login" className="font-semibold text-[#9C544D] hover:text-[#9C544D] underline underline-offset-2">Sign In</Link>
          </p>
        </div>
      </div>
    </PageShell>
