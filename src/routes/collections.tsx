...
const COLLECTIONS = [
  { slug: "bridal", name: "Bridal Edit", emoji: "👑", bg: "from-[#fdf2e0] via-[#e8c0a0] to-[#8b1a4a]" },
  { slug: "solitaires", name: "Solitaire Story", emoji: "💎", bg: "from-[#f0f4f8] via-[#e2eaf2] to-[#cdd8e6]" },
  { slug: "everyday", name: "Everyday Elegance", emoji: "✨", bg: "from-[#fdf8f3] via-[#f5e8d0] to-[#e8c98a]" },
  { slug: "festive", name: "Festive Heirlooms", emoji: "📿", bg: "from-[#fdf2e0] via-[#f0d8a8] to-[#c9a96e]" },
  { slug: "men", name: "For Him", emoji: "🔮", bg: "from-[#f0f0f0] via-[#d0d0d0] to-[#7a7a7a]" },
  { slug: "gifting", name: "The Gift Edit", emoji: "🎁", bg: "from-[#fdf0e8] via-[#f0c8b0] to-[#a85040]" },
];
