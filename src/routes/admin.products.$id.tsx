...
function EditProductPage() {
  ...
  useEffect(() => {
    let cancelled = false;
    Promise.all([productsApi.getWithImages(id), categoriesApi.list(true)])
      .then(([p, cats]) => {
        if (cancelled) return;
        if (p) {
          setProduct(p);
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <Section title="Attributes">
            <p className="mb-3 text-xs text-gray-400">
              Add unlimited product attributes. Existing attributes show with a label; type a new
              name to create a new attribute.
            </p>
              ...
              <div key={i} className="mb-2 flex items-center gap-2">
                ...
                {row.name && attrDefs.find((d) => d.id === row.defId) ? (
                  ...
                  <input
                    ...
                    className="flex-1 rounded-lg border border-gray-300 px-4 py-2.5 text-sm outline-none focus:border-[#9C544D]"
                  />
                )}
                <input
                  type="text"
            ...
            <button
              ...
              className="mt-3 flex items-center gap-1 text-sm font-medium text-[#9C544D] hover:text-[#9C544D]"
            >
            ...
            {attrDefs.length > 0 && (
              <p className="mt-2 text-xs text-gray-400">
                ...
                <Link to="/admin/attributes" className="text-[#9C544D] hover:underline">
                  Attributes
                </Link>
                .
              </p>
        ...
        <div className="space-y-6">
          ...
          <Section title="Flags">
            ...
            <Link
              ...
              className="mt-2 inline-flex items-center gap-1 text-xs font-medium text-[#9C544D] hover:text-[#9C544D]"
            >
              Manage Flags →
            </Link>
          </Section>
