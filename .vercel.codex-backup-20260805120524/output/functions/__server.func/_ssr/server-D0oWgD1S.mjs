...
import { A as executeRewriteInput, D as getStylesheetHref, E as getScriptPreloadAttrs, F as rootRouteId, I as isNotFound, M as isResolvedRedirect, O as resolveManifestAssetLink, R as invariant, a as replaceSsrResponse, i as normalizeSsrResponse, j as isRedirect, k as resolveManifestCssLink, n as defineHandlerCallback, o as stripSsrResponseBody, r as isSsrResponse, t as renderRouterToStream, u as RouterProvider } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v--mI6eZMk.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CnDhKL5U.mjs"),
		import("./start-3BxFFDrx.mjs"),
