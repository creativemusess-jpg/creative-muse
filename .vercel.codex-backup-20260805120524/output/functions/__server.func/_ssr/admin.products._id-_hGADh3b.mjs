...
//#region node_modules/.nitro/vite/services/ssr/assets/admin.products._id-_hGADh3b.js
...
function EditProductPage() {
	...
	(0, import_react.useEffect)(() => {
		let cancelled = false;
		Promise.all([productsApi.getWithImages(id), categoriesApi.list(true)]).then(([p, cats]) => {
			if (cancelled) return;
			if (p) {
				setProduct(p);
				setForm({
					...
					original_price: p.original_price || void 0,
					cost_price: p.cost_price || void 0,
					badge: p.badge,
					status: p.status,
		...
		Promise.all([
			...
			setAttrDefs(defs || []);
			setAllFlags(flags || []);
			if (existingFlags) setSelectedFlagIds(existingFlags.map((f) => f.id));
			setProductAttrs((existingAttrs || []).map((a) => ({
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			setSelectedFlagIds(freshFlags.map((f) => f.id));
			setProductAttrs((freshAttrs || []).map((a) => ({
				defId: a.attribute_definition_id,
				value: a.value,
				name: a.attribute_definition?.name || ""
			})));
	...
	if (!product || !form) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Product not found" }) });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AdminLayout, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminPageHeader, {
		...
		actions: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [saving && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }), saving ? "Saving..." : "Save Changes"]
		})
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Add unlimited product attributes. Existing attributes show with a label; type a new name to create a new attribute."
						}),
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Created: ", new Date(product.created_at).toLocaleDateString()] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Updated: ", new Date(product.updated_at).toLocaleDateString()] }),
