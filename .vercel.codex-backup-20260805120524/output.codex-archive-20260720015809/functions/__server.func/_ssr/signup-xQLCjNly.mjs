...
import { ct as EyeOff, q as LoaderCircle, st as Eye } from "../_libs/lucide-react.mjs";
import { n as useAuth } from "./auth-DdCdXWLm.mjs";
import { v as Link, y as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/signup-xQLCjNly.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[11px] font-semibold tracking-[0.24em] text-[#c9a96e] uppercase text-center",
					children: "Join"
				}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									...
									className: "w-full rounded-xl border border-[#e0d8cc] px-4 py-3 pr-12 text-sm outline-none focus:border-[#c9a96e]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					className: "flex w-full items-center justify-center gap-3 rounded-xl border border-[#e0d8cc] bg-white px-4 py-3 text-sm font-medium text-[#1a1a2e] transition-colors hover:border-[#c9a96e] hover:bg-[#fdf8f3]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/login",
							className: "font-semibold text-[#c9a96e] hover:text-[#b8860b] underline underline-offset-2",
							children: "Sign In"
						})
					]
				})
